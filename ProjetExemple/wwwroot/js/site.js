...
//}
    ...
    document.querySelector('.menu-toggle').addEventListener('click', function () {
        ...
        document.querySelector('.div_nav').classList.toggle('menu-open'); // Ajoute ou supprime la classe menu-open
        document.querySelector('.conteneur-des-boutons').classList.toggle('menu-open'); // Ajoute ou supprime la classe menu-open
   });
